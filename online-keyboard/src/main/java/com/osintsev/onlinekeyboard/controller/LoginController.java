...
import com.osintsev.onlinekeyboard.repository.RoleRepository;
...
public class LoginController {
    ...
    public String registerPost(@ModelAttribute("user") User user, HttpServletRequest r) throws ServletException{
        ...
        r.login(user.getEmail(),password);
        return "redirect:/";
